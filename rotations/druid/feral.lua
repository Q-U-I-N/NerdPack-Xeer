...
local _Xeer = {
	-- some test stuff, DO NOT USE THIS
	--{'@Xeer.Targeting()', {'!target.alive', 'toggle(AutoTarget)'}},
	--{'@Xeer.AutoDoT(Moonfire,Moonfire)'},
	--{'@Xeer.AutoDoT(Rake,Rake)'},
	--{'@Xeer.AutoDoT(Rip,Rip)'},
	--{'@Xeer.AutoDoT(Thrash,Thrash)'},
...
local Cooldowns = {
	...
	--# Use Regrowth at 5 Combo Points, if Predatory Swiftness is about to fall off, at 2 Combo Points before Ashamane's Frenzy, before Elune's Guidance is cast or before the Elune's Guidance buff gives you a 5th Combo Point.
...
local Finisher = {
	...
	--{Savage_Roar, 'talent(5,3)&{{!player.buff(Savage Roar)&combo_points=5}||{!player.buff(Savage Roar)&{talent(7,1)&action(Brutal Slash).charges>0}&talent(5,2)}}'},
